...
;;Stuff for the packagemanager, requires package.el to be places in *libfolder*,
...
;;This is the packages that I want to be automatically installed if they are not
;;alreaddy installed
(defvar required-packages (list 'browse-kill-ring
        'smart-tab
        'auto-complete
        'color-theme
        'pandoc-mode
...
(when (esk-online?)
  ...
  (elpa-install-required-packages))
